            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('tourTypes.update',$tourType->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="form-group mb-3">
                                <label for="attribute_id">Loại hình du lịch:</label>
                                <input type="text" class="form-control" id="name_type" name="name_type" value="{{ $tourType->name_type }}" required>
                            </div>
